...
appEventData.push({
  "event": "Page Load Started",
    ...
    "user": {
        ...
        "dealerFirmPersonalization": "<dealerFirmPersonalization>",
...
|page.siteAudience|string|Audience portion of the site name \(audience\/country\/language\). This value can't be null. Ex: Advisor, Individual, ...|Advisor, Individual, Institutional|||||||
...
|user.dealerFirmPersonalization|string|Dealer Firm Personalization|MS, GA|||||||
