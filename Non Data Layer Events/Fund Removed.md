...
| --- | --- | --- | --- |
|Fund Removals|Static|scRemove|Description not provided|
|Set category to 'product'|Static|product|Description not provided|

## Attached Notes

<p>This event is used to capture fund removed analytics when user removing any funds in filter from self service or tool</p>
